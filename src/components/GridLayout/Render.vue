<template>
	<div :class="`${propsData.type}-setting`" style="height: 100%">
		...
		<Select
			...
			"
		></Select>
		<div ref="echartsRef" v-if="propsData.type === ComponentsType.LINEBAR" class="echart"></div>
		<GridLayout
...
const onSelectChange = (value: any, option: any) => {
	console.log('onSelectChange', value, option, props.layoutItem, props.layoutData);
